    ...
    <div className="min-h-screen">
      ...
      <div className="pt-24 pb-20">
        ...
        <section className="container mx-auto px-4 py-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { name: "Elena Stormwind", role: "Creative Director", description: "Visionary storyteller with 15+ years in fantasy game design" },
              { name: "Marcus Ironforge", role: "Lead Developer", description: "Technical wizard specializing in immersive game mechanics" },
              { name: "Luna Silvermoon", role: "Art Director", description: "Master artist bringing magical worlds to life" },
            ].map((member, index) => (
              <motion.div
                key={index}
