        ...
        <div className="relative z-20 container mx-auto px-4 text-center">
          ...
          >
            ...
            >
              ...
              <Link to="/marketplace">
                <Button size="lg" variant="outline" className="border-accent text-primary-foreground hover:bg-accent/20 text-lg px-8 py-6">
                  Visit Marketplace
                </Button>
              </Link>
              <Link to="/about">
                <Button size="lg" variant="outline" className="border-primary-foreground text-primary-foreground hover:bg-primary-foreground/10 text-lg px-8 py-6">
                  About Us
                </Button>
              </Link>
            </motion.div>
